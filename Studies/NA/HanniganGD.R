...
#Opens the data
ye <- curatedMetagenomicData("HanniganGD_2017.relative_abundance", dryrun = F, counts = T, rownames = "long")
ye.se <- ye[[1]]
...
#renames rownames to species name
...
#filters results to only contain bacteria of interest
...
#makes volcano plot
png(filename = "volcanoHanniganGD.png", res = 300, height = 1800, width = 2500)
EnhancedVolcano(rd,
                lab = rd$genus,
                pCutoff = 0.05,
