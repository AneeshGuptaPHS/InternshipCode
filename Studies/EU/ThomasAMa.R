...
#opens the data
ye <- curatedMetagenomicData("ThomasAM_2018a.relative_abundance", dryrun = F, counts = T, rownames = "long")
ye.se <- ye[[1]]
...
#makes volcano plot
png(filename = "volcanoThomasAMa.png", res = 300, height = 1800, width = 2500)
EnhancedVolcano(rd,
                lab = rownames(rd),
                pCutoff = 0.05,
