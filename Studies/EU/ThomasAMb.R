...
#opens the data
ye <- curatedMetagenomicData("ThomasAM_2018b.relative_abundance", dryrun = F, counts = T, rownames = "long")
ye.se <- ye[[1]]
...
#makes volcano plot
png(filename = "volcanoThomasAMb.png", res = 300, height = 1800, width = 2500)
EnhancedVolcano(rd,
                lab = rd$genus,
                pCutoff = 0.05,
