...
#Opens the data
ye <- curatedMetagenomicData("YachidaS_2019.relative_abundance", dryrun = F, counts = T, rownames = "long")
ye.se <- ye[[1]]
...
png(filename = "volcanoYachidaS.png", res = 300, height = 1800, width = 2500)
EnhancedVolcano(rd,
                lab = rd$genus,
                pCutoff = 0.05,
